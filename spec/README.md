...
| [voice.md](voice.md) | **v6 (planned)** E2EE voice — embedded mediasoup SFU, end-to-end frame encryption, voice channels + 1:1 calls, key reuse from chat/v5 |
...
- **Planned:** v6 – v8 — see [roadmap.md](roadmap.md). v6 voice has a detailed
  design spec in [voice.md](voice.md) (not yet implemented).
